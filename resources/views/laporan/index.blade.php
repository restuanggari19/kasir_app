                ...
                <form class="card" method="POST" target="_blank" action="{{ route('laporan.perbulan') }}">
                    ...
                    <div class="card-body">
                        ...
                        <x-group class="row">
                            <div class="col">
                                @php
                                    $data = [['value' => '', 'option' => 'Pilih'], ['value' => 1, 'option' => 'Januari'], ['value' => 2, 'option' => 'Februari'], ['value' => 3, 'option' => 'Maret'], ['value' => 4, 'option' => 'April'], ['value' => 5, 'option' => 'Mei'], ['value' => 6, 'option' => 'Juni'], ['value' => 7, 'option' => 'Juli'], ['value' => 8, 'option' => 'Agustus'], ['value' => 9, 'option' => 'September'], ['value' => 10, 'option' => 'Oktober'], ['value' => 11, 'option' => 'November'], ['value' => 12, 'option' => 'Desember']];
                                @endphp
